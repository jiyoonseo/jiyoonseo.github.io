                ...
                <ul class="nav nav-tabs nav-justified navbar-nav">
                    ...
                    <li class="dropdown"><a href="gallery.php" data-toggle="dropdown">Gallery <span class="caret"></span></a>
                    	<ul class="dropdown-menu">
                            ...
                            <li><a href="gallery.phpl#social">Social &amp; Others</a></li>
                        </ul>                    
                    </li>
...
<div class="modal fade" id="wront_email" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="myModalLabel">Failed to login - Wrong Email</h4>
      </div>
      <div class="modal-body">
          <p>The email address<strong> 
          <?php
          echo $_COOKIE['failed_loggedin_email'] ;
          //setcookie('successfully_loggedin', '0', time()+3600); 
          
          ?>
          </strong> is not valid. Please register first.
          </p>
      </div>
      <div class="modal-footer">
        <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
        <button type="submit" class="btn btn-default">Go to Home Page</button>
        <button type="button" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#register">Go to Register</button>
      </div>
    </div>
  </div>
</div>
